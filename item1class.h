...
void item1::setprops()
{
    ...
    cout << "Enter new element property 2 (integer value)\n";
    while ( !(PromtValue(&(this->value2))) );
      
    cout << "Enter new element property 3 (integer value)\n";
...
void item1::savetofile(string fname)
{
    ofstream curfile;
...
void item1::loadfromfile(ifstream& tfile)
{
    string line;
